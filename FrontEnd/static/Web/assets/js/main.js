(function ($) {
    ...
    $(document).ready(function($){
        ...
        $(".logo-carousel-inner").owlCarousel({
            ...
            loop: true,
            autoplay: true,
            autoplayTimeout: 1000, // Adjust the timeout here (in milliseconds)
    autoplaySpeed: 1200, // Adjust the speed of the animation (in milliseconds)
        margin: 10,
            responsive:{
                0:{
                    items:1,
       ...
       // Countdown with 30 additional days
if($('.time-countdown').length){
    $('.time-countdown').each(function() {
        var $this = $(this),
            finalDate = $(this).data('countdown');

        // Convert finalDate to a Date object
        finalDate = new Date(finalDate);

        // Add 30 days to the final date
